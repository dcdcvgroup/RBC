...
def modify_command_options(opts):
    ...
    if opts.method is not None:
        ...
        if opts.method == 'SEPARATE':
            ...
            opts.init_balanced = True
            opts.separate = True
            opts.feature_matching = False
            opts.logit_matching = True
...
def get_argparser():
    ...
    ### weighted ce
    parser.add_argument("--weighted_ce", action="store_true", default=False, help="use weighted cross entropy loss or not")
    ###
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        choices=['FT', 'LWF', 'LWF-MC', 'ILT', 'EWC', 'RW', 'PI', 'MiB', 'PLOP', 'SEPARATE'],
    ...
    parser.add_argument(
        ...
        default=False,
        action='store_true',
        help="Enable to use separate training"
    )

    parser.add_argument(
        "--feature_matching", action="store_true", default=False, help="feature matching"
    )

    parser.add_argument(
        "--logit_matching", action="store_true", default=False, help="logit matching"
    )
